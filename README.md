# 個人房貸試算器 (Home Loan Calculator)

這是一個基於 C# WinForms 開發的個人房貸試算工具，旨在提供使用者直覺、精確的貸款還款分析。本專案為「視窗程式設計 (II)」課程作業一。
...
## 🛠 執行說明
1. 環境需求：Visual Studio 2022 與 .NET 運行環境。
2. 複製此儲存庫 (Repository)：
   ```bash
   git clone https://github.com/Zhang-chen415/HomeLoanCalculator
   ```
